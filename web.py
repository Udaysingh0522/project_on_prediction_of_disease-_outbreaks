...
if selected == 'Heart Diseases Prediction':
    ...
    if st.button('Heart Diseases Test Result'):
        ...
        if heart_prediction[0]==1:
            heart_diagnosis ='The Preson Have Heart Diseases'
        else:
            heart_diagnosis='The Person Not Have Heart Diseases'
...
if selected == 'Parkinsons Prediction':
    ...
    if st.button("Parkinson's  Test Result"):
        ...
        if parkinsons_prediction[0]==1:
            parkinsons_diagnosis='The Preson Have parkinsons Diseases'
        else:
            parkinsons_diagnosis='The Person Not Have parkinsons Diseases'
